...
### [**→ Open unwarp.app**](https://unwarp.app)

*Works on every modern browser. Install it to your home screen on iPhone & Mac.*
...
Native shells exist because **meeting recording needs OS-level audio capture** (the speaker on the other end of a Zoom / Meet / Teams call), which a browser can't reliably do. For everything else, the [web app](https://unwarp.app) is identical.
...
| 1. Speak | 2. Polish | 3. Find |
|:---:|:---:|:---:|
| Tap once. Talk freely. Pause, ramble, change your mind — we'll keep up. | AI removes the ums, fixes typos, learns your dictionary, writes the title. | Search every note ever — by exact phrase, by gist, or jump to the second something was said. |

</div>

```
Tap  →  Talk  →  We do the rest.
```
...
- 🎙️ **Voice-first capture** — tap the floating button, talk, stop. Installable PWA on iPhone & Android home screens.
- ✨ **Notes that polish themselves** — one round-trip turns rambling speech into a clean Markdown note with a title, tags, and a topic.
- ✅ **To-dos pulled out for you** — every action item arrives with a due date when one was mentioned, and a link that jumps you back to the exact second in the audio.
...
Priced for **humans**, not procurement. **14-day trial, no card required.**
...
| **Workspaces** | Create as many as you want | Auto-provisioned, shared by default |
| **Billing** | One card | One bill for the whole team |

### [**→ Start your trial at unwarp.app**](https://unwarp.app)
...
- 🔐 **End-to-end encrypted in transit**, encrypted at rest.
- 🚫 **No third-party telemetry.** No analytics scripts, no error reporters, nothing phones home.
- 📦 **Full data export, anytime** — your notes are yours; leave with everything.
- 🛡️ **Row-level security on every table** — your notes are visible only to you and the workspace members you choose.
...
### Stop writing things down. *Speak them.*
